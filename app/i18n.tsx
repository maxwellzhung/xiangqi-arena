...
const english = {
  ...
  "settings.piecesCopy":
    "English mode uses readable three-letter labels with a built-in key. Chinese mode uses traditional piece characters.",
  "settings.pieceDisplay": "Piece display",
  "settings.general": "ABC  English labels",
  "settings.traditional": "帥  Chinese characters",
...
const simplifiedChinese: TranslationTable = {
  ...
  "settings.pieces": "棋子",
  "settings.piecesCopy":
    "英文模式使用易读的三字母标签并附有图例；中文模式使用传统棋子汉字。",
  "settings.pieceDisplay": "棋子显示",
  "settings.general": "ABC  英文标签",
  "settings.traditional": "帥  中文棋子",
...
const traditionalChinese: TranslationTable = {
  ...
  "settings.pieces": "棋子",
  "settings.piecesCopy":
    "英文模式使用易讀的三字母標籤並附有圖例；中文模式使用傳統棋子漢字。",
  "settings.pieceDisplay": "棋子顯示",
  "settings.general": "ABC  英文標籤",
  "settings.traditional": "帥  中文棋子",
...
const japanese: TranslationTable = {
  ...
  "settings.pieces": "駒",
  "settings.piecesCopy":
    "英字モードでは読みやすい3文字ラベルと凡例を表示し、中国語モードでは伝統的な漢字を使います。",
  "settings.pieceDisplay": "駒の表示",
  "settings.general": "ABC  英字ラベル",
  "settings.traditional": "帥  中国語表記",
