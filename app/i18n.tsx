...
const english = {
  ...
  "language.copy":
    "Choose the language used throughout Xiangqi Arena. This choice is saved on this device.",
  "nav.menu": "Menu",
  ...
  "brand.home": "Xiangqi Arena home",
  "footer.tagline": "Modern Xiangqi for curious minds.",
  "footer.rules": "Rules",
  ...
  "home.titleLine1": "The fastest way",
  "home.titleLine2": "into Xiangqi.",
  "home.lede":
    "Chinese Chess is fast, tactical, and surprisingly easy to begin. Play a real game in seconds, with clear guidance built in.",
  ...
  "intro.leaderboard.title": "The Arena leaderboard",
...
const simplifiedChinese: TranslationTable = {
  "language.label": "语言",
  "language.heading": "语言",
  "language.copy": "选择象棋竞技场的界面语言。此选择将保存在当前设备上。",
  "nav.menu": "菜单",
  "nav.main": "主导航",
  "nav.play": "对弈",
  "nav.learn": "学习",
  ...
  "nav.playNow": "立即对弈",
  "brand.home": "象棋竞技场首页",
  "footer.tagline": "为好奇的头脑打造的现代象棋体验。",
  "footer.rules": "规则",
  "footer.privacy": "隐私",
  "footer.terms": "条款",
  "footer.settings": "设置",
  ...
  "home.titleLine1": "最快上手",
  "home.titleLine2": "中国象棋。",
  "home.lede":
    "中国象棋节奏明快、战术丰富，而且上手并不难。几秒钟即可开始真正的对局，并在清晰指引下边下边学。",
  "home.playNow": "立即对弈",
  "home.private": "创建私人对局",
  ...
  "intro.leaderboard.title": "竞技场排行榜",
  "intro.leaderboard.copy":
...
const traditionalChinese: TranslationTable = {
  ...
  "language.label": "語言",
  "language.heading": "語言",
  "language.copy": "選擇象棋競技場的介面語言。此選擇將儲存在目前裝置上。",
  "nav.menu": "選單",
  "nav.main": "主導覽",
  "nav.play": "對弈",
  "nav.learn": "學習",
  ...
  "home.titleLine1": "最快上手",
  "home.titleLine2": "中國象棋。",
  "home.lede":
    "中國象棋節奏明快、戰術豐富，而且並不難上手。幾秒內即可開始真正的對局，並在清楚指引下邊下邊學。",
  "home.playNow": "立即對弈",
  "home.private": "建立私人對局",
  ...
  "intro.leaderboard.title": "競技場排行榜",
  "intro.leaderboard.copy":
...
const japanese: TranslationTable = {
  ...
  "language.heading": "言語",
  "language.copy":
    "Xiangqi Arena で使用する表示言語を選択します。この設定はこの端末に保存されます。",
  "nav.menu": "メニュー",
  "nav.main": "メインナビゲーション",
  "nav.play": "対局",
  "nav.learn": "学ぶ",
  ...
  "nav.signIn": "ログイン",
  "nav.playNow": "今すぐ対局",
  "brand.home": "Xiangqi Arena ホーム",
  "footer.tagline": "好奇心を刺激する、現代のシャンチー。",
  "footer.rules": "ルール",
  ...
  "home.titleLine1": "最短で始める",
  "home.titleLine2": "シャンチー。",
  "home.lede":
    "中国将棋はテンポが速く、戦術的で、驚くほど簡単に始められます。わかりやすいガイドとともに、数秒で本格的な対局を始めましょう。",
  "home.playNow": "今すぐ対局",
  ...
  "intro.leaderboard.title": "アリーナランキング",
  "intro.leaderboard.copy":
